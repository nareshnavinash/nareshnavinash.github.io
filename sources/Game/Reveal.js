...
export class Reveal {
    ...
    updateStep(step) {
        ...
        if (step === 0) {
            ...
            if (percentEl) percentEl.classList.add('is-hidden')
            ...
            this.game.world.intro.circle.hide(() => {
                ...
                // Cherry trees
                if (this.game.world.cherryTrees) this.game.world.cherryTrees.leaves.seeThroughMultiplier = 0.5
            ...
            // Reveal name text
            if (this.game.world.areas && this.game.world.areas.landing) {
                this.game.world.areas.landing.revealName()
            }
            ...
            if (this.game.world.cherryTrees) {
                gsap.to(this.game.world.cherryTrees.leaves, {
