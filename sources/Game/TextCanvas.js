...
export class TextCanvas {
    ...
    updateText(text) {
        ...
        if (typeof text === 'string') this.lines.push(text)
        else if (text instanceof Array) this.lines = text
    ...
    getMeasure() {
        ...
        for (const line of this.lines) {
            ...
            if (measure.width > output.width) output.width = measure.width
        }
    ...
    draw() {
        ...
        for (const line of this.lines) {
            ...
            else if (this.horizontalAlign === 'left') x = 0
            else if (this.horizontalAlign === 'right') x = this.width
