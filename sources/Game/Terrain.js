...
export class Terrain {
    ...
    setGradient() {
        ...
        const update = () => {
            ...
            for (const color of this.colors) gradient.addColorStop(color.stop, color.value)
    ...
    update() {
        // Tracks delta
        this.tracksDelta.value.set(this.game.tracks.focusPoint.x, this.game.tracks.focusPoint.y)
    }
}
