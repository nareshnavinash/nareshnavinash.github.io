...
export class ResourcesLoader {
    ...
    getLoader(_type) {
        if (this.loaders.has(_type)) return this.loaders.get(_type)
    ...
    load(_files, _progressCallback = null) {
        return new Promise((resolve, reject) => {
            ...
            const progress = () => {
                ...
                if (typeof _progressCallback === 'function') _progressCallback(toLoad, _files.length)
            ...
            const save = (_file, _resource) => {
                // Apply modifier
                if (typeof _file[3] !== 'undefined') _file[3](_resource)
