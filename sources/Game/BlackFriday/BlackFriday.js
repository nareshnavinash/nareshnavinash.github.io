...
export class BlackFriday {
    constructor() {
        ...
        this.game.inputs.events.on('close', (action) => {
            if (action.active) {
                if (this.outro.visible) this.outro.hide()
                else if (this.intro.visible) this.intro.hide()
                else {
                    if (this.fragments.allCaught) this.outro.show()
                    else this.intro.show()
                }
            }
        })

        if (this.game.debug.active) this.intro.hide()
    }
    ...
    setFragments() {
        ...
        this.fragments.tryCatch = (_fragment) => {
            if (_fragment.distance < this.fragments.catchDistance && !_fragment.caught) this.fragments.catch(_fragment)
        }
        ...
        this.fragments.testOver = () => {
            this.fragments.allCaught = this.fragments.list.reduce((accumulator, fragment) => {
