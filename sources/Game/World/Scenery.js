...
export class Scenery {
    ...
    setRoad() {
        ...
        this.road.color = uniform(color('#343038'))
        ...
        if (this.game.debug.active) {
            ...
            debugPanel.addBinding(this.road.glitterScarcity, 'value', {
                label: 'glitterScarcity',
                min: 0,
                max: 1,
                step: 0.001
            })
            debugPanel.addBinding(this.road.glitterLighten, 'value', {
                label: 'glitterLighten',
                min: 0,
                max: 1,
                step: 0.001
            })
            debugPanel.addBinding(this.road.middleLighten, 'value', {
                label: 'middleLighten',
                min: 0,
                max: 0.2,
                step: 0.001
