...
export class Grid {
    ...
    setVisual() {
        ...
        this.mesh = new THREE.Mesh(new THREE.PlaneGeometry(100, 100), uvGridMaterial)
        ...
        if (this.game.debug.active) {
            ...
            for (const line of lines) {
                ...
                lineDebugPanel
                    .addBinding({ color: '#' + line.color.value.getHexString(THREE.SRGBColorSpace) }, 'color')
                    .on('change', (tweak) => line.color.value.set(tweak.value))
            }
        }
    }
