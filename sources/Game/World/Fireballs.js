...
export class Fireballs {
    constructor() {
        ...
        if (this.game.debug.active) {
            ...
            this.debugPanel.addBinding(this.emissiveStrength, 'value', {
    ...
    create(coordinates, fireRadius = 5, explosionRadius = 5) {
        ...
        material.outputNode = Fn(() => {
            ...
            const noise = add(noiseX.mul(blending.x), noiseY.mul(blending.y), noiseZ.mul(blending.z))
                .remap(0.15, 0.9, 0, 1)
                .toVar()
            ...
            // Emissive
            const emissiveColor = mix(this.emissiveColorA, this.emissiveColorB, noise)
