...
export class WindLines {
    constructor() {
        ...
        this.pool = [new WindLine(), new WindLine(), new WindLine(), new WindLine()]
        ...
        if (this.game.debug.active) {
            ...
            this.debugPanel
                .addBinding(this, 'thickness', {
                    min: 0,
                    max: 1,
                    step: 0.001
                })
                .on('change', () => {
                    for (const windLine of this.pool) windLine.thickness.value = this.thickness
                })
        }
    ...
    display() {
        ...
        windLine.mesh.position.x =
            this.game.view.focusPoint.position.x + (Math.random() - 0.5) * this.game.view.optimalArea.radius
        windLine.mesh.position.z =
            this.game.view.focusPoint.position.z + (Math.random() - 0.5) * this.game.view.optimalArea.radius
