...
export default class LoadingScreen {
    constructor(game, options = {}) {
        ...
        if (window.__embed) this._skipCinematic = true
    ...
    _buildEntranceTimeline() {
        ...
        tl.to(
            this.container.querySelectorAll('.ls-role-dot'),
            {
                opacity: 1,
                duration: 0.3,
                stagger: 0.1
    ...
    _simulateLoading() {
        ...
        const interval = setInterval(() => {
            ...
            const speed = progress < 0.3 ? 0.03 : progress < 0.7 ? 0.015 : 0.025
    ...
    _transitionStatusMessage(msg) {
        ...
        gsap.to(this._statusText, {
            ...
            onComplete: () => {
                this._statusText.textContent = msg
                gsap.fromTo(this._statusText, { opacity: 0, y: 6 }, { opacity: 1, y: 0, duration: 0.25 })
            }
        })
    }
    ...
    _enter() {
        ...
        tl.to(this._btn, {
            scale: 1.15,
            boxShadow: '0 0 50px rgba(0,255,170,0.7), 0 0 120px rgba(0,255,170,0.3)',
            duration: 0.3,
            ease: 'power2.in'
        })
        ...
        const contentEls = [
            this._greeting,
            this.container.querySelector('.ls-title'),
