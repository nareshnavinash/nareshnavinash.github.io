...
export default class Weather {
    ...
    update(dt) {
        ...
        this.fogDensityMult =
            this._previousValues.fogDensityMult + (target.fogDensityMult - this._previousValues.fogDensityMult) * s
        this.windStrength =
            this._previousValues.windStrength + (target.windStrength - this._previousValues.windStrength) * s
        this.rainIntensity =
            this._previousValues.rainIntensity + (target.rainIntensity - this._previousValues.rainIntensity) * s
        this.snowIntensity =
            this._previousValues.snowIntensity + (target.snowIntensity - this._previousValues.snowIntensity) * s
