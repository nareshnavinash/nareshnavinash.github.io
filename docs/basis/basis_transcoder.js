var BASIS = (() => {
    ...
    return function (moduleArg = {}) {
        ...
        var ensureoverwriteTable = (proto, methodName, humanName) => {
        ...
        var exposePublicSymbol = (name, value, numArguments) => {
            if (Module.hasOwnProperty(name)) {
                ...
                ensureoverwriteTable(Module, name, name)
        ...
        var __embind_register_class_constructor = (
            ...
            whenDependentTypesAreResolved([], [rawClassType], (classType) => {
                ...
                if (undefined !== classType.registeredClass.constructor_body[argCount - 1]) {
                    throw new BindingError(
                        `Cannot register multiple constructors with identical number of parameters (${argCount - 1}) for class '${classType.name}'! overwrite resolution is currently only performed using the parameter count, not actual type info!`
                    )
                }
        ...
        var __embind_register_class_function = (
            ...
            whenDependentTypesAreResolved([], [rawClassType], (classType) => {
                ...
                if (
                    ...
                    ensureoverwriteTable(proto, methodName, humanName)
        ...
        var ___cxa_is_pointer_type = (a0) => (___cxa_is_pointer_type = wasmExports['R'])(a0)
