...
describe('resume-loader.js', () => {
    ...
    describe('populateSeo()', () => {
        ...
        it('should set all meta tags', () => {
            ...
            expect(document.querySelector('#meta-description').getAttribute('content')).toBe(
                resumeData.site.seo.description
            )
        ...
        it('should set Open Graph tags', () => {
            ...
            expect(document.querySelector('#meta-og-site-name').getAttribute('content')).toBe(
                resumeData.site.seo.ogSiteName
            )
        ...
        it('should set Twitter tags', () => {
            ...
            expect(document.querySelector('#meta-twitter-card').getAttribute('content')).toBe(
                resumeData.site.seo.twitterCard
            )
            expect(document.querySelector('#meta-twitter-title').getAttribute('content')).toBe(
                resumeData.site.seo.title
            )
        })
    ...
    describe('populateNavigation()', () => {
        ...
        it('should set nav aria labels', () => {
            ...
            expect(document.querySelector('#main-nav').getAttribute('aria-label')).toBe(
                resumeData.site.navigation.mainAriaLabel
            )
            expect(document.querySelector('#mobile-menu').getAttribute('aria-label')).toBe(
                resumeData.site.navigation.mobileAriaLabel
            )
        })
    ...
    describe('populateHero()', () => {
        it('should set hero greeting', () => {
            ...
            const expected =
                resumeData.site.hero.greetingPrefix +
                resumeData.personal.firstName +
                resumeData.site.hero.greetingSuffix
    ...
    describe('populate() - full integration', () => {
        ...
        it('should render career section titles', () => {
            ...
            const rendered = Array.from(titles)
        ...
        it('should render publication links', () => {
            ...
            expect(document.querySelector('.btn-primary').getAttribute('href')).toBe(
                resumeData.publications.book.amazonUrl
            )
            expect(document.querySelector('.btn-secondary').getAttribute('href')).toBe(
                resumeData.publications.book.mediumUrl
            )
        })
        ...
        it('should render contact section', () => {
            ...
            expect(document.querySelector('#contact-email').getAttribute('href')).toBe(
                'mailto:' + resumeData.personal.email
            )
        })
        ...
        it('should set back to top aria-label', () => {
            ...
            expect(document.querySelector('#back-to-top').getAttribute('aria-label')).toBe(
                resumeData.site.labels.backToTopAriaLabel
            )
        })
    })
    ...
    describe('populate() - fallback branches', () => {
        ...
        it('should handle about cards with more than 3 items (icon fallback)', () => {
            ...
            const data = {
                ...
                site: {
                    ...
                    navigation: {},
                    hero: {},
                    contact: { primarySocialKeys: [] },
                    footer: { extraSocialKeys: [] },
                    labels: {}
                },
                social: {},
                about: {
        ...
        it('should handle role without sections property', () => {
            ...
            const data = {
                ...
                career: {
                    title: 'C',
                    positions: [{ company: 'TestCo', roles: [{ date: '2024', role: 'Dev', location: 'NYC' }] }]
                },
                skills: { title: 'S', categories: [] },
                leadership: { title: 'L', cards: [] },
                certifications: { title: 'Ce', items: [] },
            ...
            const data = {
                ...
                career: {
                    ...
                    positions: [
                        {
                            company: 'TestCo',
                            roles: [{ date: '2024', role: 'Dev', location: 'NYC', sections: [{ title: 'Sec' }] }]
                        }
                    ]
                },
                skills: { title: 'S', categories: [] },
        ...
        it('should handle social item with name but use key as fallback', () => {
            ...
            const data = {
                ...
                site: {
                    ...resumeData.site,
                    contact: { primarySocialKeys: ['custom'] },
                    footer: { extraSocialKeys: ['custom'] }
                }
            }
            populate(data)
        ...
        it('should handle unknown social icon key', () => {
            ...
            const data = {
                ...
                site: {
                    ...resumeData.site,
                    contact: { primarySocialKeys: ['twitter'] },
                    footer: { extraSocialKeys: [] }
                }
            }
            populate(data)
    ...
    describe('populate() - edge cases', () => {
        ...
        it('should handle empty social keys', () => {
            const data = {
                ...
                site: {
                    ...resumeData.site,
                    contact: { primarySocialKeys: ['missing'] },
                    footer: { extraSocialKeys: ['missing'] }
                }
            }
            populate(data)
